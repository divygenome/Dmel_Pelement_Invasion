...
From the resulting .fq.gz.PPI251 files, we extracted and assembled the P-element copy number values into a single file, then removed the "G" from the generation coloumn to aid visualisation.
...
pele_dna_cn <- ggplot(d, aes(x = generation, y = `copy number`, group= replicate)) + 
