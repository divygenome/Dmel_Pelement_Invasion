...
First, we obtained the reference D. mel fasta file from Flybase, then ran the following command to remove everything but the Flybase ID from the identifier line, while also attaching "_mRNA" for downstream analysis.
