...
```
We then used this annotation file with featurecounts for assessing expression levels in all mapped bam files, using the following script (make sure that featurecounts is active in the current environment).
