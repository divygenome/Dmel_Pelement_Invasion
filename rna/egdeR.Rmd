---
title: "Edge-R - differential expression"
...
dflmvs2$fdr_color <- ifelse(dflmvs2$fdr < fdr, "darkgrey",
                            ifelse(dflmvs2$fdr < fdr2, "orange", "red"))

pvs2 <- ggplot(data = dflmvs2, aes(y = -log10(pval), x = logfc, color = fdr_color)) +
